...
template <typename T>
T parse_wkt(boost::string_view wkt)
{
    grammar<T> gr;
    T res;
...
inline auto geom_from_text(boost::string_view wkt)
{
    return detail::parse_wkt<geometry>(wkt);
}

inline auto point_from_text(boost::string_view wkt)
{
    return detail::parse_wkt<point>(wkt);
}

inline auto line_from_text(boost::string_view wkt)
{
    return detail::parse_wkt<linestring>(wkt);
}

inline auto poly_from_text(boost::string_view wkt)
{
    return detail::parse_wkt<polygon>(wkt);
}

inline auto mpoint_from_text(boost::string_view wkt)
{
    return detail::parse_wkt<multi_point>(wkt);
}

inline auto mline_from_text(boost::string_view wkt)
{
    return detail::parse_wkt<multi_linestring>(wkt);
}

inline auto mpoly_from_text(boost::string_view wkt)
{
    return detail::parse_wkt<multi_polygon>(wkt);
}

inline auto geom_coll_from_text(boost::string_view wkt)
{
